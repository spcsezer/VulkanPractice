...
void VulkanEngine::updateUniformBuffer(uint32_t currentImage)
{
	...
	ubo.view = glm::lookAt(camera.position, camera.position + camera.front, glm::vec3(0.0f, 1.0f, 0.0f));
...
void Camera::handleKey(GLFWwindow* window)
{
